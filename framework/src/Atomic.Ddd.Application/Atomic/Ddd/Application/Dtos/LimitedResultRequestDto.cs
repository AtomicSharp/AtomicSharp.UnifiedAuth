...
using Atomic.Ddd.Application.Atomic.Ddd.Application.Localization;
...
namespace Atomic.Ddd.Application.Atomic.Ddd.Application.Dtos
{
    ...
    public class LimitedResultRequestDto : IValidatableObject
    {
        ...
        public virtual IEnumerable<ValidationResult> Validate(ValidationContext validationContext)
        {
            ...
            {
                var localizer = validationContext.GetRequiredService<IStringLocalizer<AtomicDddApplicationResource>>();
